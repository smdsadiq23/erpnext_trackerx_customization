...
update_rate_from_bom: function (frm, cdt, cdn) {
    ...
    frappe.call({
        method: "erpnext_trackerx_customization.api.purchase_order.get_rate_from_bom_by_order_method",
        args: {
        ...
        callback: function (r) {
            if (r.message && r.message.rate !== undefined) {
                ...
                setTimeout(() => {
                    ...
                    console.log("✅ Rate set in data model. New value:", locals[cdt][cdn].rate);
